class Piece:
  ...
  def move(self, direction) -> int:
    newPos: list[list[int]] = [[i[0]+direction[0]+self.piecePos[0], i[1]+direction[1]+self.piecePos[1]] for i in self.squarePos]
...
class IPiece(Piece):
  def __init__(self, board) -> None:
    ...
    self.color = 1
    self.rotation1 = [[0, 2], [1, 2], [2, 2], [3, 2]]

    #
    self.squarePos = self.rotation1
